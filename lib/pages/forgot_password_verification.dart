                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10,),
                            Text(
                              'Введи код підтвердження, який ми щойно надіслали на вказану електронну адресу.',
                              style: TextStyle(
                                // fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black54
                                      ...
                                      ..onTap = () {
                                        showDialog(
                                          ...
                                          builder: (BuildContext context) {
                                            return ThemeHelper().alartDialog("Успішно",
                                                "Ми повторно надіслали код підтвердження.",
                                                context);
                                          },
                                        );
                                      },
