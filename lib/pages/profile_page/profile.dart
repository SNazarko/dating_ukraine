...
import 'package:dating_ukraine/pages/profile_page/profile_model.dart';
...
import '../auth_reg_pages/auth_reg_model.dart';
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              child: TextFormField(
                                ...
                                onChanged: (String val) => modelProfile.setName(val),
                              ),
                            ...
                            Container(
                              child: TextFormField(
                                ...
                                onChanged: (String val) => modelProfile.setDateOfBirth(val),
                              ),
                              decoration: ThemeHelper().inputBoxDecorationShaddow(),
                            ),
                            ...
                            Container(
                              child: TextFormField(
                                ...
                                onChanged: (String val) => modelProfile.setRegion(val),
                              ),
                              decoration: ThemeHelper().inputBoxDecorationShaddow(),
                            ),
                            SizedBox(height: 20.0),
                            Container(
                              child: TextFormField(
                                ...
                                onChanged: (String val) => modelProfile.setCity(val),
                              ),
                              decoration: ThemeHelper().inputBoxDecorationShaddow(),
                            ),
                            SizedBox(height: 20.0),
                                  ...
                                  child: DropdownButtonHideUnderline(
                                    child: DropdownButton2(
                                      ...
                                      items: items_1
                                          ...
                                          .toList(),
                                      value: modelProfile.getSex,
                                      onChanged: (value) {
                                        modelProfile.setSex(value.toString());
                                      },
                                      icon: const Icon(
                                  ...
                                  child: DropdownButtonHideUnderline(
                                    child: DropdownButton2(
                                      ...
                                      items: items_2
                                          ...
                                          .toList(),
                                      value: modelProfile.getSex2,
                                      onChanged: (value) {
                                        modelProfile.setSex2(value.toString());
                                      },
                                      icon: const Icon(
                                        Icons.keyboard_arrow_down,
                                      ),
                            ...
                            DropdownButtonHideUnderline(
                              child: DropdownButton2(
                                ...
                                items: items_3
                                    ...
                                    .toList(),
                                value: modelProfile.getPurpose,
                                onChanged: (value) {
                                  modelProfile.setPurpose(value.toString());
                                },
                                icon: const Icon(
                                  Icons.keyboard_arrow_down,
                                ),
