                          ...
                          Container(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Padding(
                                ...
                                child: modelAuthReg.getIsLoading
                              ...
                              onPressed: () async{
                                if (_formKey.currentState!.validate()) {
                                  modelAuthReg.isLoading(true);
                                  final bool response = await
                                      modelAuthReg.register();
                                  if (response) {
                                    Navigator.of(context).pushAndRemoveUntil(
                                        MaterialPageRoute(
                                            builder: (context) => ProfilePage()),
                                        (Route<dynamic> route) => false);
                                    modelAuthReg.isLoading(false);
                                  }else{
                                    modelAuthReg.isLoading(false);
                                  }
                                }
